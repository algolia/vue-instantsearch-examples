          ...
          <ais-results>
            <template scope="{ result }">
              <div class="search-result">
                <img class="result__image img-responsive"
                  :src="result.image">
                ...
                <div class="result__info">
                  ...
                  <div class="result__rating">
                    <template v-for="n in 5">
                      <span v-if="n <= result.rating"
                        class="result__star"></span>
                      <span v-else
                        class="result__star--empty"></span>
                    </template>
                  </div>
...
const searchStore = createFromAlgoliaCredentials("latency", "6be0576ff61c053d5f9a3225e2a90f76")
